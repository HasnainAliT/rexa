# Model Card: Star Prediction Regressor
...
Aggregates coverage/depth/structure signals into a final rating, replacing `WeightedStarPredictor`.
...
| rmse | 0.406 |
| spearman_rho | 0.8909 |
| within_one_star_accuracy | 1.0 |
| quadratic_weighted_kappa | 0.9048 |
...
| spearman_rho | 0.8788 |
| within_one_star_accuracy | 1.0 |
| quadratic_weighted_kappa | 0.9239 |
...
python scripts/export_model_card.py --module star_prediction
```
